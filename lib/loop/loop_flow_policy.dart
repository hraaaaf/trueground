...
const Map<LoopPattern, LoopPatternContent> loopPatternContent =
    <LoopPattern, LoopPatternContent>{
...
const Map<LoopNextAction, LoopActionContent> loopActionContent =
    <LoopNextAction, LoopActionContent>{
